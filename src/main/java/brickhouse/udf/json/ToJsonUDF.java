...
public class ToJsonUDF extends GenericUDF {
    ...
    public class StringInspectorHandle implements InspectorHandle {
    ...
    public static void writeString(JsonGenerator gen, String str) throws IOException {
    ...
    private class TimestampInspectorHandle implements InspectorHandle {
        ...
        public void generateJson(JsonGenerator gen, Object obj) throws JsonGenerationException, IOException {
            if (obj == null) {
                ...
                writeTimestamp(gen, timestamp, isoFormatter);
            }
        }
    ...
    public static void writeTimestamp(JsonGenerator gen, Timestamp timestamp, DateTimeFormatter isoFormatter) throws
            IOException {
...
//            }
    ...
    public ObjectInspector initialize(ObjectInspector[] args)
        ...
        if (args.length != 1 && args.length != 2) {
            throw new UDFArgumentException(" ToJson takes an object as an argument, " +
                    "and an optional to_camel_case flag");
        }
